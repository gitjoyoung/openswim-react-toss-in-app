...
update public.pools set images=ARRAY['https://dkvkectdsohdystvlacq.supabase.co/storage/v1/object/public/pool-images/c4514579-e102-4feb-9be1-f059f9940d7f.webp']::text[] where id='e99d5630-2f13-4614-a5cc-85c7f2438f5d';  -- keep 동탄복합문화센터내 실내수영장
delete from public.pools where id='c4514579-e102-4feb-9be1-f059f9940d7f';  -- dup 동탄복합문화센터
update public.pools set images=ARRAY['https://dkvkectdsohdystvlacq.supabase.co/storage/v1/object/public/pool-images/966372c0-c439-447d-9bde-d912564535fd.webp']::text[] where id='74968640-880c-4f8a-9b88-c5592011ae74';  -- keep 안산 선부다목적체육관수영장
...
update public.pools set images=ARRAY['https://dkvkectdsohdystvlacq.supabase.co/storage/v1/object/public/pool-images/d8fe65db-5c69-4a5f-8bbc-345f6c2c6f58.webp']::text[] where id='5984fec4-a26c-4c46-a273-ae8eb7abac59';  -- keep 의정부시청소년회관 실내수영장
...
update public.pools set images=ARRAY['https://dkvkectdsohdystvlacq.supabase.co/storage/v1/object/public/pool-images/57a2dccc-93d8-4ab2-a424-f9c19a172339.jpg']::text[] where id='270cf550-8d82-4dbd-9f34-2688efaf09ba';  -- keep 목포실내체육관 실내수영장
...
update public.pools set images=ARRAY['https://dkvkectdsohdystvlacq.supabase.co/storage/v1/object/public/pool-images/f142dd8a-93ef-4b86-98a6-7919eead98b9.webp']::text[] where id='dfaa5809-815b-4a53-846e-5eeab977c8d4';  -- keep 국민체육센터 수영장
...
update public.pools set images=ARRAY['https://dkvkectdsohdystvlacq.supabase.co/storage/v1/object/public/pool-images/e0547886-8983-40cc-a68c-de439fc71f89.webp']::text[] where id='8759430c-7d9b-46f1-aa21-9841f6c1191d';  -- keep 고양체육관 수영장
delete from public.pools where id='e0547886-8983-40cc-a68c-de439fc71f89';  -- dup 고양체육관
update public.pools set images=ARRAY['https://dkvkectdsohdystvlacq.supabase.co/storage/v1/object/public/pool-images/75394380-19b8-45e2-8d25-1e3e0e7189af.webp']::text[] where id='183220c3-272e-497d-9113-111802378246';  -- keep 성남종합스포츠센터 수영장
